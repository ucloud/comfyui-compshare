...
# normalization_loras is not used in this specific class but kept for consistency with the example if other similar classes might need it.
from ..utils import BaseRequest, image_to_base64, normalization_loras
...
class Step1xEdit(BaseRequest):
    ...
    image: Tensor = Field(
        ..., description="The image to generate an image from. Needs to match the dimensions of the mask.")
    ...
    num_inference_steps: Optional[int] = Field(
        default=30, ge=1, le=50, description="The number of inference steps to perform.")
