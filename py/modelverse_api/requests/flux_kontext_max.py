...
class FluxKontextMax(BaseRequest):
    """
    ...
    def field_order(self):
        ...
        return ["model", "prompt", "image", "seed", "guidance_scale", "response_format"]


class FluxKontextMaxMulti(BaseRequest):
    """
    ...
    def field_order(self):
        """Corresponds to x-order-properties in the JSON request_schema."""
        return ["model", "prompt", "images", "seed", "guidance_scale", "response_format"]


class FluxKontextMaxT2I(BaseRequest):
    """
